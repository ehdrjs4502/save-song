...
function SearchUser() {
  ...
  async function getUserList() {
    ...
    await axios
      .post("http://localhost:3001/search/searchUser", {
        id: inputText,
      })
      .then((res) => {
        ...
        <div className="search-box">
          <div className="search-form">
            <input
              ...
              placeholder="유저 아이디 또는 유저명 입력"
              onKeyPress={handleOnKeyPress}
              onKeyUp={getUserList}
              onChange={onChangeSearch}
            />
            <button type="button" className="search-btn" onClick={getUserList}>
                ...
                {searchList.map((item) => {
                  return (
                    <tr>
                      ...
                      <td>
                        <FollowBtn toID={item.id} fromID={id} />
                      </td>
                    </tr>
                  );
                })}
